...
`Rooti` is a living desktop ornament. A procedural tree grows organically in the background of you screen, simulating real biological processes — branching, auxin suppression, gravitropism — while remaining fully transparent and non-intrusive. You can click through it, work normally, and just glance over occasionally to see how your tree is doing.
...
- **Live parameter tuning** — settings panel to adjust growth rate, branching behaviour, gravitropism, and more without restarting
